    ...
    public static final class StockKeepingUnit extends
        ...
        protected final Object dynamicMethod(
            ...
            switch (method) {
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (StockKeepingUnit.class) {
                            if (PARSER == null) {
    ...
    public static final class InventoryStock extends
        ...
        protected final Object dynamicMethod(
            ...
            switch (method) {
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (InventoryStock.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
    ...
    public static final class LicenseKeyManagement extends
        ...
        protected final Object dynamicMethod(
            ...
            switch (method) {
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (LicenseKeyManagement.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
    ...
    public static final class SaleInventory extends
        ...
        protected final Object dynamicMethod(
            ...
            switch (method) {
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (SaleInventory.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
    ...
    public static final class CreditDetail extends
        ...
        protected final Object dynamicMethod(
            ...
            switch (method) {
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (CreditDetail.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
